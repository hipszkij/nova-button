...
```bash
composer require hipszkij/nova-button
```
...
```php
use hipszkij\NovaButton\Button;
```
...
Default event: `hipszkij\NovaButton\Events\ButtonClick`.
...
The defaults are defined in the [config file](https://github.com/hipszkij/nova-button/blob/main/config/nova-button.php).
...
The passed key refers to one of the classes defined in the [config file](https://github.com/hipszkij/nova-button/blob/main/config/nova-button.php).
...
Next, register a listener for the `hipszkij\NovaButton\Events\ButtonClick` event in your [EventServiceProvider](https://laravel.com/docs/7.x/events):
...
- Nova 4 package [hipszkij](https://github.com/hipszkij)
